...
/**
 * Serves files from the mod_classengage file areas.
 *
 ...
 */
function classengage_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options = []) {
    ...
    $fs = get_file_storage();
    $file = $fs->get_file($context->id, 'mod_classengage', $filearea, $itemid, $filepath, $filename);
