...
// Settings
$string['settings:nlpendpoint'] = 'Legacy NLP Service Endpoint';
$string['settings:nlpendpoint_desc'] = 'Legacy Node.js service endpoint (optional, only for backward compatibility).';
$string['settings:nlpapikey'] = 'Legacy NLP API Key';
$string['settings:nlpapikey_desc'] = 'Legacy API key for the Node.js service (optional, backward compatibility only).';
$string['settings:nlppublicurl'] = 'Legacy NLP Public URL (Browser Access)';
$string['settings:nlppublicurl_desc'] = 'Legacy public URL for Node.js assets (optional).';
$string['settings:nlpproviders'] = 'NLP Provider Settings';
$string['settings:nlpproviders_desc'] = 'Configure one or more AI providers for question generation.';
$string['settings:nlpproviderstest'] = 'Test NLP Providers';
$string['settings:nlpproviderstest_desc'] = 'Run a quick request against each configured provider.';
$string['settings:nlpdefaultprovider'] = 'Default AI Provider';
$string['settings:nlpdefaultprovider_desc'] = 'Primary provider used for generation (fallbacks apply if unavailable).';
$string['settings:nlpproviderpriority'] = 'Provider Priority Order';
$string['settings:nlpproviderpriority_desc'] = 'Comma-separated fallback order (e.g., gemini,openai,anthropic,deepseek,kimi,kimicn).';
$string['settings:geminiapikey'] = 'Gemini API Key';
$string['settings:geminiapikey_desc'] = 'API key for Google Gemini.';
$string['settings:geminimodel'] = 'Gemini Model';
$string['settings:geminimodel_desc'] = 'Gemini model identifier (e.g., gemini-2.5-flash).';
$string['settings:openaiapikey'] = 'OpenAI API Key';
$string['settings:openaiapikey_desc'] = 'API key for OpenAI.';
$string['settings:openaimodel'] = 'OpenAI Model';
$string['settings:openaimodel_desc'] = 'OpenAI model identifier (e.g., gpt-4o).';
$string['settings:openaibaseurl'] = 'OpenAI Base URL';
$string['settings:openaibaseurl_desc'] = 'Custom OpenAI-compatible API base URL if needed.';
$string['settings:anthropicapikey'] = 'Anthropic API Key';
$string['settings:anthropicapikey_desc'] = 'API key for Anthropic Claude.';
$string['settings:anthropicmodel'] = 'Anthropic Model';
$string['settings:anthropicmodel_desc'] = 'Claude model identifier (e.g., claude-3-5-sonnet-20241022).';
$string['settings:deepseekapikey'] = 'DeepSeek API Key';
$string['settings:deepseekapikey_desc'] = 'API key for DeepSeek.';
$string['settings:deepseekmodel'] = 'DeepSeek Model';
$string['settings:deepseekmodel_desc'] = 'DeepSeek model identifier (e.g., deepseek-chat).';
$string['settings:deepseekbaseurl'] = 'DeepSeek Base URL';
$string['settings:deepseekbaseurl_desc'] = 'Custom DeepSeek-compatible base URL if needed.';
$string['settings:kimiapikey'] = 'Kimi API Key';
$string['settings:kimiapikey_desc'] = 'API key for Kimi (Moonshot).';
$string['settings:kimimodel'] = 'Kimi Model';
$string['settings:kimimodel_desc'] = 'Kimi model identifier (e.g., moonshotai/kimi-k2:free).';
$string['settings:kimibaseurl'] = 'Kimi Base URL';
$string['settings:kimibaseurl_desc'] = 'Base URL for Kimi API.';
$string['settings:kimicnapikey'] = 'Kimi CN API Key';
$string['settings:kimicnapikey_desc'] = 'API key for Kimi China (Moonshot CN).';
$string['settings:kimicnmodel'] = 'Kimi CN Model';
$string['settings:kimicnmodel_desc'] = 'Kimi CN model identifier (e.g., moonshot-v1-8k).';
$string['settings:kimicnbaseurl'] = 'Kimi CN Base URL';
$string['settings:kimicnbaseurl_desc'] = 'Base URL for Kimi CN API.';
$string['nlptest_heading'] = 'NLP Provider Test';
$string['nlptest_intro'] = 'Run a simple one-question test against each configured provider. Results appear below.';
$string['nlptest_prompt_label'] = 'Sample prompt text';
$string['nlptest_prompt_used'] = 'Prompt used';
$string['nlptest_defaultprompt'] = 'Machine learning is a subset of artificial intelligence that focuses on patterns in data.';
$string['nlptest_run'] = 'Run tests';
$string['nlptest_provider'] = 'Provider';
$string['nlptest_status'] = 'Status';
$string['nlptest_message'] = 'Message';
$string['nlptest_model'] = 'Model';
$string['nlptest_questions'] = 'Generated questions';
$string['nlptest_question'] = 'Question {$a}';
$string['nlptest_field_question'] = 'Question text';
$string['nlptest_field_optiona'] = 'Option A';
$string['nlptest_field_optionb'] = 'Option B';
$string['nlptest_field_optionc'] = 'Option C';
$string['nlptest_field_optiond'] = 'Option D';
$string['nlptest_field_correct'] = 'Correct answer';
$string['nlptest_field_difficulty'] = 'Difficulty';
$string['nlptest_field_cognitive'] = 'Cognitive level';
$string['nlptest_field_rationale'] = 'Rationale';
$string['nlptest_field_image'] = 'Question image';
$string['nlptest_metadata'] = 'Metadata';
$string['nlptest_none'] = 'None';
$string['nlptest_missing'] = 'Provider not available.';
$string['nlptest_notconfigured'] = 'API key not configured.';
$string['nlptest_success'] = 'Success (questions: {$a->count}, model: {$a->model})';
$string['nlptest_skipped'] = 'Not tested.';
$string['settings:autogeneratequestions'] = 'Auto-generate Questions on Upload';
$string['settings:autogeneratequestions_desc'] = 'Automatically generate quiz questions when slides are uploaded (requires at least one AI provider configured).';
