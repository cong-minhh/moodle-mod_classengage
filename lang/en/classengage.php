...
$string['settings:nlpexecutionmode_desc'] = 'Controls how user-triggered inspection and question generation requests run. Auto uses inline execution for simple workloads, but prefers background tasks when the current runtime would lose richer PDF processing such as page previews or external PDF extraction.';
