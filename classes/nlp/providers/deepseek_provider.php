...
class deepseek_provider extends provider_base {
    protected $name = 'deepseek';
    protected $description = 'DeepSeek AI Provider';
    ...
    public function generate_questions($input, array $options = []): array {
        ...
        foreach ($models as $model) {
            ...
            try {
                ...
                $url = rtrim($this->config['baseURL'] ?? 'https://api.deepseek.com/v1', '/');
        ...
        throw new \Exception('DeepSeek generation failed: ' . ($lasterror ? $lasterror->getMessage() : 'unknown error'));
    }
