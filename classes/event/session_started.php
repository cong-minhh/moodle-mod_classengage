...
/**
 * The session started event class.
 */
class session_started extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventsessionstarted', 'mod_classengage');
    }
    ...
    public function get_url() {
        return new \moodle_url('/mod/classengage/controlpanel.php', 
            array('id' => $this->contextinstanceid, 'sessionid' => $this->objectid));
    }
}
